        ...
        <ul className='flex xl:justify-center overflow-x-auto'>
          ...
          <li>
            <a href='#frozen-worlds'>
              <img
                className='img-icons'
                src='src\img\mundos-congelados.png'
          ...
          <li>
            <a href='#desert-fields'>
              <img
                className='img-icons'
                src='src\img\desertos-campos.png'
                alt='Campos'
              />
          ...
          <li>
            <a href='#coastal-seas'>
              <img
                className='img-icons'
                src='src\img\mares-costeiras.png'
                alt='Marés Costeiras'
              />
